...
function Header() {
  ...
  //   convenient format
  // later on, we can use this to filter the results
  ...
  return (
    <header className="flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5">
      ...
      <div className="w-full md:max-w-2xl">
        <form
          action={(formData) => {
            ...
            if (pages) params.set("page", pages.toString());
        ...
        >
          ...
          <div
            className="grid grid-cols-2 gap-2 p-4 
                md:grid-cols-4 max-w-lg 
                md:max-w-none mx-auto items-center"
          >
            <SearchSelect
      ...
      <div className="hidden lg:flex flex-1 justify-end">
        <Avatar name="Sojin Samuel" round size="50" />
      </div>
    </header>
  );
}
